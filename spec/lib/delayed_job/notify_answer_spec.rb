...
describe DelayedJob::NotifyAnswer do
  ...
  it "should notify to question and answers user" do
    ...
    answer1 = Factory(:answer, :question => question, :user => answer_user1, :answer_body => AnswerBody.new(:body => 'answer1'))
    answer_user2 = Factory(:user, :email => 'answer2@gmail.com')
    answer2 = Factory(:answer, :question => question, :user => answer_user2, :answer_body => AnswerBody.new(:body => 'answer2'))
    answer_user3 = Factory(:user, :email => 'answer3@gmail.com')
    answer3 = Factory(:answer, :question => question, :user => answer_user3, :answer_body => AnswerBody.new(:body => 'answer3'))

    answer = Factory(:answer, :question => question, :user => answer_user2, :answer_body => AnswerBody.new(:body => 'answer'))
